...
alias ips='ip -o -4 address show | cut -f 2,7 -d " " | cut -f 1 -d "/"'
alias updog='ip -o -4 address show | cut -f 2,7 -d " " | cut -f 1 -d "/" ; python3 -m updog'
...
export PS1='\[\033[01;31m\]Pwn\[\033[01;34m\]\w\[\033[00m\]$ '
